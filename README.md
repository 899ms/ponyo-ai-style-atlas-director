...
> 把用户熟悉的知名导演、动画工作室、经典 IP 和艺术大师的“氛围感”，转译成可执行、可商用、更安全的视觉风格 DNA、提示词、故事板和视频提示词。
...
`templates/` 用于固定输出结构。  
`examples/` 用于测试 Skill 是否真的能输出导演级氛围，而不是通用风格。

## 一句话定位

> 这不是一个“AI 风格关键词表”，而是一个把知名导演与经典 IP 的氛围拆解成视觉 DNA、提示词、故事板和视频镜头的 AI 风格导演 Skill。
